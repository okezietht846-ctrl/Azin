...
// Calculate the total available balance using the accessor
$totalBalance = $user->getAccBalanceAttribute();
...
// Record the withdrawal request without decrementing the balance
...
$txnInfo = Txn::new(
    ...
    $type,
    TxnStatus::Pending, // Status is set to Pending
...
notify()->success(__('Withdrawal Request Submitted Successfully'), 'Success');
return redirect()->back();

// Proceed with payment and transaction creation
$payAmount = $amount * $withdrawMethod->rate;
