...
public function updateCurrency(Request $request)
{
    ...
    $request->validate([
        'site_currency' => 'required|string|in:USD,EUR,GBP,CNY', // Add other currencies if needed
    ]);
    ...
    $selectedCurrency = $request->input('site_currency');
    $selectedSymbol = $currencies[$selectedCurrency] ?? '$'; // Default to USD if not found

    // Update the user's currency preferences
    $user->site_currency = $selectedCurrency;
    $user->currency_symbol = $selectedSymbol;
    $user->save();
