                    ...
                    <div class="profile-card">
                        <div class="top">
                            ...
                            <div class="btns">
                                ...
                                @endcan
                                @can('customer-balance-add-or-subtract')
    <span data-bs-toggle="modal" data-bs-target="#newAddSubBalance">
        <a href="javascript:void(0);" type="button" class="site-btn-round primary-btn"
           data-bs-placement="top" title="Fund Add or Subtract">
...
@endcan
                                ...
                                <div class="row">
                                    ...
                                    <div class="admin-user-balance-card">
                                            ...
                                            <div class="wallet-info">
                                                ...
                                                <div
                                                    class="balance">{{ setting('currency_symbol','global') . $user->acc_balance }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="admin-user-balance-card">
                                            <div class="wallet-name">
                                                <div class="name">{{ __('Signup Bonus') }}</div>
                                                <div class="chip-icon">
                                                    <img
                                                        class="chip"
                                                        src="{{asset('backend/materials/chip.png')}}"
                                            ...
                                            <div class="wallet-info">
                                                <div class="wallet-id">{{ setting('site_currency','global') }}</div>
                                                <div
                                                    class="balance">{{ setting('currency_symbol','global') . $user->totalProfit() }}</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="wallet-info">
                                                <div class="wallet-id">{{ setting('site_currency','global') }}</div>
                                                <div
                                                    class="balance">{{ setting('currency_symbol','global') . $user->totalReferralProfit() }}</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="wallet-info">
                                                <div class="wallet-id">{{ setting('site_currency','global') }}</div>
                                                <div
                                                    class="balance">{{ setting('currency_symbol','global') . $user->totaldeposit_bonus }}</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="wallet-info">
                                                <div class="wallet-id">{{ setting('site_currency','global') }}</div>
                                                <div
                                                    class="balance">{{ setting('currency_symbol','global') . $user->totalInvestment_bonus }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="admin-user-balance-card">
                                            ...
                                            <div class="wallet-info">
                                                <div class="wallet-id">{{ setting('site_currency','global') }}</div>
                                                <div
                                                    class="balance">{{ setting('currency_symbol','global') . $user-> totalInvestment()}}</div>
                                            </div>
                                        </div>
    ...
    @can('customer-balance-add-or-subtract')
        ...
        @include('backend.user.include.__newbalance')
    @endcan
