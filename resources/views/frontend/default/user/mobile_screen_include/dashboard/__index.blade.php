    ...
    <div class="col-12">
        ...
        <div class="user-wallets-mobile">
            ...
            <div class="one">
                ...
                <div class="balance">
                    <span class="symbol">{{ $currencySymbol }}</span>{{ $user->acc_balance }}<span
                        class="after-dot">.{{ strpos($user->acc_balance, '.') ? Str::after($user->acc_balance, '.') : '00' }} </span>
                </div>
                <div class="wallet">{{ __('Account Balance') }}</div>
            ...
            <div class="one p-wal">
                <div class="balance">
                    <span class="symbol">{{ $currencySymbol }}</span>{{ $user->totalProfit }}<span
                        class="after-dot">.{{ strpos($user->totalProfit, '.') ? Str::after($user->totalProfit, '.') : '00' }} </span>
                </div>
                <div class="wallet">{{ __('Signup Bonus') }}</div>
            </div>
