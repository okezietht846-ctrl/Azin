                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($withdraws as $raw)
                                        <tr>
                                            ...
                                            <td><strong class="red-color">-{{ $raw->amount }} {{ auth()->user()->currency_symbol }}</strong></td>
                                            <td><strong class="red-color">-{{ $raw->charge }} {{ auth()->user()->currency_symbol }}</strong></td>
                                            <td>
                        ...
                        @foreach($withdraws as $raw)
                            <div class="single-transaction">
                                ...
                                <div class="transaction-right">
                                    <div class="transaction-amount sub">
                                        - {{ $raw->amount }} {{ auth()->user()->currency_symbol }}
                                    </div>
                                    <div class="transaction-fee sub">
                                        -{{ $raw->charge }} {{ auth()->user()->currency_symbol }} {{ __('Fee') }}
                                    </div>
