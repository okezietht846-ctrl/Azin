                            ...
                            <div class="transaction-list table-responsive">
                                <table class="table preview-table">
                                    ...
                                    <tr>
                                        ...
                                        <td id="amount">
                                            {{ $schema->type == 'range' ? 'Minimum ' . $schema->min_amount . ' ' . auth()->user()->currency_symbol . ' - ' . 'Maximum ' . $schema->max_amount . ' ' . auth()->user()->currency_symbol : $schema->fixed_amount . ' ' . auth()->user()->currency_symbol }}
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="input-group mb-0">
                                                <select class="site-nice-select" aria-label="Default select example"
                                                    ...
                                                    <option
                                                        value="main">{{ __('Main Wallet ( ') . $user->balance . ' ' . auth()->user()->currency_symbol . ' )' }}
                                                    </option>
                                                    <option
                                                        value="profit">{{ __('Profit Wallet ( ') . $user->profit_balance . ' ' . auth()->user()->currency_symbol . ' )' }}
                                                    </option>
                                    ...
                                    <tr>
                                        ...
                                        <td id="return-interest">{{ ($schema->interest_type == 'percentage' ? $schema->return_interest . '%' : $schema->return_interest . ' ' . auth()->user()->currency_symbol) . ' (' . $schema->schedule->name . ')' }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><span id="total-amount">{{ $schema->fixed_amount ?? '' }}</span> {{ auth()->user()->currency_symbol }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
