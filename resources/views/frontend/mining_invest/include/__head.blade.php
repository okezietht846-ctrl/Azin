<head>
    ...
    <!-- Prevent social media platforms from generating previews -->
    <meta name="robots" content="max-image-preview:none">
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{ setting('site_title', 'global') }} - @yield('title')">
    ...
    @endif
    <link rel="stylesheet" href="{{ asset('frontend/theme_base/mining_invest/css/styles.css?var=1') }}"/>
    <style>
    ...
    <link rel="apple-touch-icon" href="{{ asset(setting('site_favicon','global')) }}">
    <script>
